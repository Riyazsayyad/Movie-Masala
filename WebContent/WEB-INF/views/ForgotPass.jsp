    ...
    <body>
        ...
        <div class="full-screen-container">
            <div class="login-container">
                ...
                <form action="ForgotpassCheck" method="post">
                    ...
                    <div class="input-group">
                        ...
                        <select name="secquestion" required="required" class="placeholder">
              ...
              <option value="Childhood Bestfriend Name?">
                Childhood Bestfriend Name?
                    ...
                    <div class="input-group">
                        <label>Answer</label>
                        <input type="text" name="secans" placeholder="Enter Answer" class="placeholder" />
                    </div>
                    <button type="submit" class="login-button" name="Success">
            Submit
          </button>
                </form>
                <br />
