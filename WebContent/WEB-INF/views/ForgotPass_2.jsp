...
pageEncoding="ISO-8859-1"%>
    ...
    <head>
        ...
        <title>Create New Password | ${userid}</title>
    ...
    <body>
        ...
        <div class="full-screen-container">
            <div class="login-container">
                <h3 class="login-title">Fill Details Correctly.</h3>
                <form action="ForgotpassCheck2" method="post"  name="frm" onsubmit="return verifypassword()">
                    <div class="input-group">
                        <label>Create Password</label>
                        <input type="password" name="pswd" id="pswd" placeholder="Create Password" class="placeholder" />
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" name="cnfpswd"   id="cnfpswd"  placeholder="Confirm Password" class="placeholder" />
                    </div>
                    <button type="submit" value="submit" class="login-button"   name="Success" >
            Submit
          </button>
                </form>
                <br />
